...
static const struct reg_value ov7251_init_setting_100fps_vga_rev_1f[] = {
    // revision 1f raw 8
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x3005, 0x02},
...
static const struct ov7251_mode_info ov7251_mode_info_data[] = {
	/* vts value pulled from reg 380e and 380f */
	{
		.width = 640,
		.height = 480,
		.vts = 522,
		.data = ov7251_init_setting_100fps_vga_rev_1f,
		.data_size = ARRAY_SIZE(ov7251_init_setting_100fps_vga_rev_1f),
		.exposure_max = 505,
		.exposure_def = 504,
		.timeperframe = {
			.numerator = 100,
...
static int ov7251_get_mbus_config(struct v4l2_subdev *sd,
				  unsigned int pad,
			     ...
			     struct v4l2_subdev_format *format)
{
	...
	__format->code = MEDIA_BUS_FMT_Y8_1X8;
